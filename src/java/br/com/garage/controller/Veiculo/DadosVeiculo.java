...
@WebServlet(name = "DadosVeiculo", urlPatterns = {"/DadosVeiculo"})
public class DadosVeiculo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         try{
            ...
            System.out.println("Problemas ao carregar dados de Veículo! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
    }
