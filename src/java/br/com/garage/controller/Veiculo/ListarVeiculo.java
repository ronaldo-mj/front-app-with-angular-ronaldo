...
@WebServlet(name = "ListarVeiculo", urlPatterns = {"/ListarVeiculo"})
public class ListarVeiculo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("Dashboard/veiculo/listar.jsp").forward(request, response);
        } catch(Exception ex){
            System.out.println("Problemas ao listar Veículo! Erro: "+ex.getMessage());
            ex.printStackTrace();
        }
    }
