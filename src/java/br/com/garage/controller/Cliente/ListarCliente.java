...
public class ListarCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
            ...
            request.getRequestDispatcher("/Dashboard/cliente/listar.jsp").forward(request, response);
        } catch(Exception ex){
            System.out.println("Problemas na Servlet ao listar Clientes! Erro: "+ex.getMessage());
            ex.printStackTrace();
